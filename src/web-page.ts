...
import { renderApiPage, renderDashboard, renderDocs, renderHome, renderJourneyPage } from "./web-components.js";
...
const API_TESTS_STYLES = `#http-client-panel{max-width:960px;margin:0 auto}.http-request-line{display:flex;gap:10px;margin-bottom:14px}.http-request-line select{flex:0 0 auto;width:auto}.http-request-line input{flex:1 1 auto;width:auto;min-width:0}.http-request-line button{flex:0 0 auto;width:auto;margin:0}.http-layout{display:grid;grid-template-columns:1fr 1fr;gap:20px;align-items:start}.http-section{margin-top:18px}.http-section-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:8px}.http-section-head h3{margin:0;font-size:.85rem;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}.http-section-head button{margin:0;width:auto;flex:0 0 auto}.http-section label{display:block;margin-bottom:6px}.http-section textarea{width:100%;min-height:110px;resize:vertical;background:#07101d;border:1px solid var(--line);color:var(--text);border-radius:10px;padding:12px;font:13px/1.5 ui-monospace,SFMono-Regular,Consolas,monospace;outline:0}.http-section textarea:focus{border-color:var(--cyan)}.http-kv-row{display:grid;grid-template-columns:1fr 1fr auto;gap:8px;margin-bottom:8px}.http-kv-row input{margin:0}.http-kv-remove{margin:0;padding:0 12px;font-weight:900}.http-response{background:#07101d;border:1px solid var(--line);border-radius:13px;padding:16px}.http-response-head{display:flex;align-items:center;gap:12px;margin-bottom:12px}.http-status{font-weight:900;padding:3px 11px;border-radius:999px;background:#07101d;border:1px solid var(--line)}.http-status.ok{color:var(--green);border-color:#2f9e6688}.http-status.redirect{color:var(--yellow);border-color:#a1782688}.http-status.error{color:var(--red);border-color:#c94b5b88}.http-response summary{cursor:pointer;color:var(--muted);font-weight:700;margin-top:10px}.http-response pre{white-space:pre-wrap;word-break:break-all;overflow:auto;margin:8px 0 0;padding:12px;background:#050b14;border:1px solid var(--line);border-radius:8px;font-size:.75rem;max-height:320px}.http-collection{border-top:1px solid var(--line);padding-top:18px;margin-top:22px}.http-collection-save{display:flex;gap:8px}.http-collection-save input{margin:0;flex:1 1 auto;width:auto;min-width:0}.http-collection-save button{margin:0;flex:0 0 auto;width:auto}.http-collection-list{display:grid;gap:8px;margin:10px 0}.http-import-row{display:flex;align-items:center;gap:10px;margin-top:14px;flex-wrap:wrap}.http-import-row button{width:auto;margin:0}.http-import-label{margin:0;padding:8px 11px;border:1px solid var(--line);border-radius:8px;color:var(--cyan);cursor:pointer;font-size:.74rem;font-weight:700}.http-import-label:hover{border-color:var(--cyan)}.http-collection-item{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 12px;background:#07101d;border:1px solid var(--line);border-radius:10px}.http-collection-load{flex:1 1 auto;width:auto;min-width:0;text-align:left;background:none;border:none;color:var(--text);cursor:pointer;padding:0;margin:0}.http-collection-load strong{display:block;color:var(--cyan)}.http-collection-load span{display:block;color:var(--muted);font-size:.75rem;margin-top:2px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}.http-collection-delete{margin:0;flex:0 0 auto;width:auto}@media(max-width:760px){.http-layout{grid-template-columns:1fr}.http-request-line{flex-wrap:wrap}}`;
