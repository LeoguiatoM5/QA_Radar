...
.auth-unavailable h1{margin:0 0 5px;font-size:1.18rem;letter-spacing:-.01em}.auth-unavailable p{margin:0 0 16px;color:var(--muted);font-size:.82rem;line-height:1.55}.auth-unavailable a{display:flex;align-items:center;justify-content:center;padding:11px;border:1px solid var(--line);border-radius:8px;background:#07101d;color:#d9e7f7;font-size:.85rem;font-weight:700;text-decoration:none}.auth-unavailable a:hover{border-color:var(--cyan);color:var(--cyan)}.auth-foot{margin:0;color:var(--muted);font-size:.75rem;text-align:center}
...
.application-item{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:14px;padding:13px 15px;border:1px solid var(--line);border-radius:10px;background:#07101d}.application-history{flex:1 0 100%;margin-top:2px;padding-top:11px;border-top:1px solid var(--line)}.application-history[hidden]{display:none}.application-run{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:10px;padding:7px 0;color:#c3d3e4;font-size:.76rem}.application-run+.application-run{border-top:1px solid #16273b}.application-run i{width:7px;height:7px;border-radius:50%;background:#ff625c}.application-run i.pass{background:#35d495}.application-run span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted)}.application-run b{color:#e7f1fa;font-weight:600;font-variant-numeric:tabular-nums}.application-run-kind{margin-right:5px;padding:2px 7px;border:1px solid #2a4d66;border-radius:999px;background:#0f2537;color:var(--cyan);font-size:.66rem;font-weight:700;letter-spacing:.04em}.application-history p{margin:0;color:var(--muted);font-size:.76rem}
...
.application-actions{display:flex;flex-wrap:wrap;gap:6px;flex:0 0 auto;max-width:100%}
...
@media(max-width:560px){.application-item{flex-direction:column;align-items:stretch}.application-actions{justify-content:flex-start}}
`;
...
.context-item{position:relative;display:flex;flex-direction:column;justify-content:center;min-width:205px;padding:9px 24px;border-right:1px solid #183047}.context-environment{min-width:235px}.context-environment:after{content:"⌄";position:absolute;right:16px;top:24px;color:#8ba0b3;font-size:.8rem}
...
.section-kicker{display:flex;align-items:center;justify-content:space-between;margin:0;color:#88a0b6;font-size:.66rem;font-weight:800;letter-spacing:.09em;text-transform:uppercase}
...
.quality-errors{left:34px;top:22px}.quality-errors strong{color:#ff625c}.quality-warnings{right:34px;top:22px;text-align:right}.quality-warnings strong{color:#f4ae38}
...
.radar-visual{position:relative;width:min(100%,390px);aspect-ratio:1;margin:13px auto 0}
...
.radar-labels text{fill:#93aabf;font:600 12px/1 Inter,ui-sans-serif,system-ui,sans-serif;letter-spacing:.02em;paint-order:stroke;stroke:#071521;stroke-width:4px;stroke-linejoin:round}.radar-labels .radar-label-value{fill:#e7f1fa;font-weight:700}
