...
export const QA_TOOLS: readonly QaToolDefinition[] = [
  ...
  },
  {
    ...
    category: "api-json",
    tags: ["json schema", "validacao", "contrato", "payload"],
  ...
  },
  {
    ...
    category: "api-json",
    tags: ["openapi", "swagger", "contrato", "breaking change", "api"],
  ...
  },
  {
    ...
    description: "Receba, inspecione e reproduza chamadas de webhook durante o teste.",
    category: "utilities",
    tags: ["webhook", "callback", "http", "integracao"],
